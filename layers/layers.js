...
//ol.proj.get("ESRI:102332").setExtent([336914.095309, 4263627.161245, 368550.608658, 4279695.443052]);
var wms_layers = [];
...
var format_Redesdeagua_2 = new ol.format.GeoJSON();
var features_Redesdeagua_2 = format_Redesdeagua_2.readFeatures(json_Redesdeagua_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Redesdeagua_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Redesdeagua_2.addFeatures(features_Redesdeagua_2);
var lyr_Redesdeagua_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Redesdeagua_2, 
                style: style_Redesdeagua_2,
                popuplayertitle: 'Redes de agua',
                interactive: false,
    title: 'Redes de agua<br />\
    <img src="styles/legend/Redesdeagua_2_0.png" /> Alto dos Espalhafatos / Ribeirinha<br />\
    <img src="styles/legend/Redesdeagua_2_1.png" /> Caixa do Figueiredo / Chão Frio<br />\
    <img src="styles/legend/Redesdeagua_2_2.png" /> Castelo Branco<br />\
    <img src="styles/legend/Redesdeagua_2_3.png" /> Chão Frio<br />\
    <img src="styles/legend/Redesdeagua_2_4.png" /> Covões / Canada Larga<br />\
    <img src="styles/legend/Redesdeagua_2_5.png" /> Estrada da Caldeira / Facho<br />\
    <img src="styles/legend/Redesdeagua_2_6.png" /> Fajã<br />\
    <img src="styles/legend/Redesdeagua_2_7.png" /> Feteira de Cima<br />\
    <img src="styles/legend/Redesdeagua_2_8.png" /> Flamengos<br />\
    <img src="styles/legend/Redesdeagua_2_9.png" /> Lombega<br />\
    <img src="styles/legend/Redesdeagua_2_10.png" /> Matriz / Conceição<br />\
    <img src="styles/legend/Redesdeagua_2_11.png" /> Miragaia/Atrás da Ladeira<br />\
    <img src="styles/legend/Redesdeagua_2_12.png" /> Norte Pequeno<br />\
    <img src="styles/legend/Redesdeagua_2_13.png" /> Praia do Norte<br />\
    <img src="styles/legend/Redesdeagua_2_14.png" /> Ribeira do Cabo<br />\
    <img src="styles/legend/Redesdeagua_2_15.png" /> Ribeira Funda<br />\
    <img src="styles/legend/Redesdeagua_2_16.png" /> Salão / Cedros<br />\
    <img src="styles/legend/Redesdeagua_2_17.png" /> Santa Bárbara / Cabeço das Moças<br />\
    <img src="styles/legend/Redesdeagua_2_18.png" /> Trupes<br />\
    <img src="styles/legend/Redesdeagua_2_19.png" /> Varadouro<br />' });
var format_Ligaesentreestruturas_3 = new ol.format.GeoJSON();
var features_Ligaesentreestruturas_3 = format_Ligaesentreestruturas_3.readFeatures(json_Ligaesentreestruturas_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Ligaesentreestruturas_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ligaesentreestruturas_3.addFeatures(features_Ligaesentreestruturas_3);
var lyr_Ligaesentreestruturas_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ligaesentreestruturas_3, 
                style: style_Ligaesentreestruturas_3,
                popuplayertitle: 'Ligações entre estruturas',
                interactive: true,
    title: 'Ligações entre estruturas<br />\
    <img src="styles/legend/Ligaesentreestruturas_3_0.png" /> Furo --> Reservatorio<br />\
    <img src="styles/legend/Ligaesentreestruturas_3_1.png" /> Nascentes --> Reservatorio<br />\
    <img src="styles/legend/Ligaesentreestruturas_3_2.png" /> Alimentaçao por gravidade<br />\
    <img src="styles/legend/Ligaesentreestruturas_3_3.png" /> Alimentaçao seja por gravidade seja por bomba<br />\
    <img src="styles/legend/Ligaesentreestruturas_3_4.png" /> Alimentaçao por bomba<br />' });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(false);lyr_Redesdeagua_2.setVisible(true);lyr_Ligaesentreestruturas_3.setVisible(false);lyr_Outrasinfraestruturas_4.setVisible(true);lyr_Reservatorios_5.setVisible(true);lyr_NascentesOutras_6.setVisible(true);lyr_NascentesPrincipais_7.setVisible(true);lyr_Furos_8.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OpenStreetMap_1,lyr_Redesdeagua_2,lyr_Ligaesentreestruturas_3,lyr_Outrasinfraestruturas_4,lyr_Reservatorios_5,group_Nascentes,lyr_Furos_8];
lyr_Redesdeagua_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'TEMA': 'TEMA', 'DESIGNACAO': 'DESIGNACAO', 'COD_INSAAR': 'COD_INSAAR', 'ENT_GESTOR': 'ENT_GESTOR', 'FREGUESIA': 'FREGUESIA', 'CONCELHO': 'CONCELHO', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_Ligaesentreestruturas_3.set('fieldAliases', {'id': 'id', 'Lien': 'Lien', 'Num': 'Num', 'Type': 'Type', });
...
lyr_Redesdeagua_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'TEMA': 'TextEdit', 'DESIGNACAO': 'TextEdit', 'COD_INSAAR': 'TextEdit', 'ENT_GESTOR': 'TextEdit', 'FREGUESIA': 'TextEdit', 'CONCELHO': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_Ligaesentreestruturas_3.set('fieldImages', {'id': 'TextEdit', 'Lien': 'TextEdit', 'Num': 'TextEdit', 'Type': 'TextEdit', });
...
lyr_Redesdeagua_2.set('fieldLabels', {'OBJECTID': 'no label', 'TEMA': 'no label', 'DESIGNACAO': 'no label', 'COD_INSAAR': 'no label', 'ENT_GESTOR': 'no label', 'FREGUESIA': 'no label', 'CONCELHO': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_Ligaesentreestruturas_3.set('fieldLabels', {'id': 'hidden field', 'Lien': 'inline label - visible with data', 'Num': 'hidden field', 'Type': 'inline label - visible with data', });
