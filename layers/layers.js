...
//ol.proj.get("ESRI:102332").setExtent([333137.328087, 4263193.934734, 370575.643798, 4280799.284733]);
var wms_layers = [];
...
var format_NascentesPrincipais_14 = new ol.format.GeoJSON();
var features_NascentesPrincipais_14 = format_NascentesPrincipais_14.readFeatures(json_NascentesPrincipais_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_NascentesPrincipais_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NascentesPrincipais_14.addFeatures(features_NascentesPrincipais_14);
var lyr_NascentesPrincipais_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NascentesPrincipais_14, 
                style: style_NascentesPrincipais_14,
                popuplayertitle: 'Nascentes Principais',
                interactive: true,
    title: 'Nascentes Principais<br />\
    <img src="styles/legend/NascentesPrincipais_14_0.png" /> Aguas Claras<br />\
    <img src="styles/legend/NascentesPrincipais_14_1.png" /> Alto do Chao<br />\
    <img src="styles/legend/NascentesPrincipais_14_2.png" /> Alto do Inverno<br />\
    <img src="styles/legend/NascentesPrincipais_14_3.png" /> Areias<br />\
    <img src="styles/legend/NascentesPrincipais_14_4.png" /> Castelhano<br />\
    <img src="styles/legend/NascentesPrincipais_14_5.png" /> Fonte dos Namorados<br />\
    <img src="styles/legend/NascentesPrincipais_14_6.png" /> Lopo<br />\
    <img src="styles/legend/NascentesPrincipais_14_7.png" /> Praia do Norte<br />' });
var format_Furos_15 = new ol.format.GeoJSON();
var features_Furos_15 = format_Furos_15.readFeatures(json_Furos_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Furos_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Furos_15.addFeatures(features_Furos_15);
var lyr_Furos_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Furos_15, 
                style: style_Furos_15,
                popuplayertitle: 'Furos',
                interactive: true,
    title: 'Furos<br />\
    <img src="styles/legend/Furos_15_0.png" /> Ativa<br />\
    <img src="styles/legend/Furos_15_1.png" /> Inativa<br />' });
var group_Nascentes = new ol.layer.Group({
                                layers: [lyr_Linhasdeagua_12,lyr_NascentesOutras_13,lyr_NascentesPrincipais_14,],
                                fold: 'open',
                                title: 'Nascentes'});

lyr_GoogleSatellite_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(false);lyr_Sistemasaquiferosversao20222027_2.setVisible(false);lyr_Sistemasaquiferosversao20172022_3.setVisible(false);lyr_Altimetria10m_4.setVisible(false);lyr_PerimetroCaptaaoAgua_5.setVisible(false);lyr_FreguesiasGrupoCentral_6.setVisible(false);lyr_Baciashidrograficas_7.setVisible(false);lyr_Falhasgeologicas_8.setVisible(false);lyr_Ligaesentreestruturas_9.setVisible(false);lyr_Outrasinfraestruturas_10.setVisible(true);lyr_Reservatorios_11.setVisible(true);lyr_Linhasdeagua_12.setVisible(false);lyr_NascentesOutras_13.setVisible(true);lyr_NascentesPrincipais_14.setVisible(true);lyr_Furos_15.setVisible(true);
...
lyr_NascentesPrincipais_14.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'TEMA': 'TEMA', 'DESIGNACAO': 'DESIGNACAO', 'REFERENCIA': 'REFERENCIA', 'ALTITUDE': 'ALTITUDE', 'CAUDAL': 'CAUDAL', 'GESTOR': 'GESTOR', 'POINT_X': 'POINT_X', 'POINT_Y': 'POINT_Y', 'FREGUESIA': 'FREGUESIA', 'CONCELHO': 'CONCELHO', 'RuleID_MON': 'RuleID_MON', 'RuleID_INS': 'RuleID_INS', 'OBS': 'OBS', 'Popup1': 'Popup1', 'PopUp2': 'PopUp2', 'PopUp3': 'PopUp3', });
lyr_Furos_15.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'id_unico': 'id_unico', 'designacao': 'designacao', 'situacao': 'situacao', 'X WGS84': 'X WGS84', 'Y WGS84': 'Y WGS84', 'Z ': 'Z ', 'Prof Agua': 'Prof Agua', 'Cote_Piezo': 'Cote_Piezo', 'freguesia': 'freguesia', 'freguesia deservida': 'freguesia deservida', 'Comentario': 'Comentario', 'popup': 'popup', 'popup1': 'popup1', 'popup2': 'popup2', 'Transmisividade': 'Transmisividade', 'Qexp ': 'Qexp ', 'Na': 'Na', 'Cl': 'Cl', 'Salinidade': 'Salinidade', 'Temperatura': 'Temperatura', 'Dist Mar': 'Dist Mar', 'Qualidade': 'Qualidade', 'Produtividade': 'Produtividade', 'Conclusao': 'Conclusao', });
...
lyr_NascentesPrincipais_14.set('fieldLabels', {'OBJECTID': 'hidden field', 'TEMA': 'hidden field', 'DESIGNACAO': 'inline label - visible with data', 'REFERENCIA': 'inline label - visible with data', 'ALTITUDE': 'inline label - always visible', 'CAUDAL': 'hidden field', 'GESTOR': 'hidden field', 'POINT_X': 'inline label - visible with data', 'POINT_Y': 'inline label - visible with data', 'FREGUESIA': 'inline label - visible with data', 'CONCELHO': 'hidden field', 'RuleID_MON': 'hidden field', 'RuleID_INS': 'hidden field', 'OBS': 'hidden field', 'Popup1': 'no label', 'PopUp2': 'no label', 'PopUp3': 'no label', });
lyr_Furos_15.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'id_unico': 'inline label - visible with data', 'designacao': 'inline label - visible with data', 'situacao': 'hidden field', 'X WGS84': 'inline label - visible with data', 'Y WGS84': 'inline label - visible with data', 'Z ': 'inline label - visible with data', 'Prof Agua': 'inline label - visible with data', 'Cote_Piezo': 'hidden field', 'freguesia': 'inline label - visible with data', 'freguesia deservida': 'hidden field', 'Comentario': 'header label - visible with data', 'popup': 'no label', 'popup1': 'no label', 'popup2': 'no label', 'Transmisividade': 'inline label - visible with data', 'Qexp ': 'inline label - visible with data', 'Na': 'inline label - visible with data', 'Cl': 'inline label - visible with data', 'Salinidade': 'inline label - visible with data', 'Temperatura': 'inline label - visible with data', 'Dist Mar': 'inline label - visible with data', 'Qualidade': 'hidden field', 'Produtividade': 'hidden field', 'Conclusao': 'hidden field', });
lyr_Furos_15.on('precompose', function(evt) {
