...
var format_Linhasdeagua_13 = new ol.format.GeoJSON();
var features_Linhasdeagua_13 = format_Linhasdeagua_13.readFeatures(json_Linhasdeagua_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Linhasdeagua_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Linhasdeagua_13.addFeatures(features_Linhasdeagua_13);
var lyr_Linhasdeagua_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Linhasdeagua_13, 
                style: style_Linhasdeagua_13,
                popuplayertitle: 'Linhas de agua',
                interactive: false,
                title: '<img src="styles/legend/Linhasdeagua_13.png" /> Linhas de agua'
            });
var format_NascentesOutras_14 = new ol.format.GeoJSON();
var features_NascentesOutras_14 = format_NascentesOutras_14.readFeatures(json_NascentesOutras_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_NascentesOutras_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NascentesOutras_14.addFeatures(features_NascentesOutras_14);
var lyr_NascentesOutras_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NascentesOutras_14, 
                style: style_NascentesOutras_14,
                popuplayertitle: 'Nascentes Outras',
                interactive: true,
                title: '<img src="styles/legend/NascentesOutras_14.png" /> Nascentes Outras'
            });
var format_NascentesPrincipais_15 = new ol.format.GeoJSON();
var features_NascentesPrincipais_15 = format_NascentesPrincipais_15.readFeatures(json_NascentesPrincipais_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_NascentesPrincipais_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NascentesPrincipais_15.addFeatures(features_NascentesPrincipais_15);
var lyr_NascentesPrincipais_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NascentesPrincipais_15, 
                style: style_NascentesPrincipais_15,
                popuplayertitle: 'Nascentes Principais',
                interactive: true,
    title: 'Nascentes Principais<br />\
    <img src="styles/legend/NascentesPrincipais_15_0.png" /> Aguas Claras<br />\
    <img src="styles/legend/NascentesPrincipais_15_1.png" /> Alto do Chao<br />\
    <img src="styles/legend/NascentesPrincipais_15_2.png" /> Alto do Inverno<br />\
    <img src="styles/legend/NascentesPrincipais_15_3.png" /> Areias<br />\
    <img src="styles/legend/NascentesPrincipais_15_4.png" /> Castelhano<br />\
    <img src="styles/legend/NascentesPrincipais_15_5.png" /> Fonte dos Namorados<br />\
    <img src="styles/legend/NascentesPrincipais_15_6.png" /> Lopo<br />\
    <img src="styles/legend/NascentesPrincipais_15_7.png" /> Praia do Norte<br />' });
var format_Furos_16 = new ol.format.GeoJSON();
var features_Furos_16 = format_Furos_16.readFeatures(json_Furos_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Furos_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Furos_16.addFeatures(features_Furos_16);
var lyr_Furos_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Furos_16, 
                style: style_Furos_16,
                popuplayertitle: 'Furos',
                interactive: true,
    title: 'Furos<br />\
    <img src="styles/legend/Furos_16_0.png" /> Ativa<br />\
    <img src="styles/legend/Furos_16_1.png" /> Inativa<br />' });
var group_Nascentes = new ol.layer.Group({
                                layers: [lyr_Linhasdeagua_13,lyr_NascentesOutras_14,lyr_NascentesPrincipais_15,],
                                fold: 'close',
                                title: 'Nascentes'});

lyr_GoogleSatellite_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(false);lyr_Sistemasaquiferosversao20222027_2.setVisible(false);lyr_Sistemasaquiferosversao20172022_3.setVisible(false);lyr_Altimetria10m_4.setVisible(false);lyr_PerimetroCaptaaoAgua_5.setVisible(false);lyr_FreguesiasGrupoCentral_6.setVisible(false);lyr_Baciashidrograficas_7.setVisible(false);lyr_Falhasgeologicas_8.setVisible(false);lyr_Redesdeagua_9.setVisible(true);lyr_Ligaesentreestruturas_10.setVisible(false);lyr_Outrasinfraestruturas_11.setVisible(true);lyr_Reservatorios_12.setVisible(true);lyr_Linhasdeagua_13.setVisible(false);lyr_NascentesOutras_14.setVisible(true);lyr_NascentesPrincipais_15.setVisible(true);lyr_Furos_16.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OpenStreetMap_1,lyr_Sistemasaquiferosversao20222027_2,lyr_Sistemasaquiferosversao20172022_3,lyr_Altimetria10m_4,lyr_PerimetroCaptaaoAgua_5,lyr_FreguesiasGrupoCentral_6,lyr_Baciashidrograficas_7,lyr_Falhasgeologicas_8,lyr_Redesdeagua_9,lyr_Ligaesentreestruturas_10,lyr_Outrasinfraestruturas_11,lyr_Reservatorios_12,group_Nascentes,lyr_Furos_16];
...
lyr_Linhasdeagua_13.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'TEMA': 'TEMA', 'DESIGNACAO': 'DESIGNACAO', 'COD_RIB': 'COD_RIB', 'RIB': 'RIB', 'ORDEM': 'ORDEM', 'BACIA': 'BACIA', 'FREGUESIA': 'FREGUESIA', 'CONCELHO': 'CONCELHO', 'INSPIREID': 'INSPIREID', 'OBS': 'OBS', 'ATUALIZACA': 'ATUALIZACA', 'DATA_ATUAL': 'DATA_ATUAL', 'Shape_Leng': 'Shape_Leng', });
lyr_NascentesOutras_14.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'TEMA': 'TEMA', 'DESIGNACAO': 'DESIGNACAO', 'SIST_AQUIF': 'SIST_AQUIF', 'USO': 'USO', 'Q_M3_D': 'Q_M3_D', 'PH': 'PH', 'T_COL': 'T_COL', 'CONDUCT': 'CONDUCT', 'CO2_LIVRE': 'CO2_LIVRE', 'ALCALINIDA': 'ALCALINIDA', 'SIO2': 'SIO2', 'NA': 'NA', 'K': 'K', 'CA': 'CA', 'MG': 'MG', 'NH4': 'NH4', 'LI': 'LI', 'FE': 'FE', 'AL': 'AL', 'SO4': 'SO4', 'CL': 'CL', 'F': 'F', 'NO3': 'NO3', 'LI_1': 'LI_1', 'SC': 'SC', 'TI': 'TI', 'V': 'V', 'MN': 'MN', 'FE_1': 'FE_1', 'CO': 'CO', 'NI': 'NI', 'CU': 'CU', 'ZN': 'ZN', 'AS_': 'AS_', 'SE': 'SE', 'BR': 'BR', 'RB': 'RB', 'SR': 'SR', 'Y': 'Y', 'NB': 'NB', 'MO': 'MO', 'CD': 'CD', 'SN': 'SN', 'I': 'I', 'CS': 'CS', 'BA': 'BA', 'LA': 'LA', 'CE': 'CE', 'ND': 'ND', 'TA': 'TA', 'W': 'W', 'PB': 'PB', 'TH': 'TH', 'U': 'U', 'TRATAMENTO': 'TRATAMENTO', 'ENTIDADE': 'ENTIDADE', 'DATA': 'DATA', 'ENVOLVENTE': 'ENVOLVENTE', 'Q_MIN': 'Q_MIN', 'Q_MAX': 'Q_MAX', 'Q_MED': 'Q_MED', 'POINT_X': 'POINT_X', 'POINT_Y': 'POINT_Y', 'FREGUESIA': 'FREGUESIA', 'CONCELHO': 'CONCELHO', 'RuleID_MON': 'RuleID_MON', 'RuleID_INS': 'RuleID_INS', });
lyr_NascentesPrincipais_15.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'TEMA': 'TEMA', 'DESIGNACAO': 'DESIGNACAO', 'REFERENCIA': 'REFERENCIA', 'ALTITUDE': 'ALTITUDE', 'CAUDAL': 'CAUDAL', 'GESTOR': 'GESTOR', 'POINT_X': 'POINT_X', 'POINT_Y': 'POINT_Y', 'FREGUESIA': 'FREGUESIA', 'CONCELHO': 'CONCELHO', 'RuleID_MON': 'RuleID_MON', 'RuleID_INS': 'RuleID_INS', 'OBS': 'OBS', });
lyr_Furos_16.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'id_unico': 'id_unico', 'designacao': 'designacao', 'situacao': 'situacao', 'X WGS84': 'X WGS84', 'Y WGS84': 'Y WGS84', 'Z ': 'Z ', 'Prof Agua': 'Prof Agua', 'Cote_Piezo': 'Cote_Piezo', 'freguesia': 'freguesia', 'freguesia deservida': 'freguesia deservida', 'Comentario': 'Comentario', 'popup': 'popup', 'popup1': 'popup1', 'popup2': 'popup2', 'Transmisividade': 'Transmisividade', 'Qexp ': 'Qexp ', 'Na': 'Na', 'Cl': 'Cl', 'Salinidade': 'Salinidade', 'Temperatura': 'Temperatura', 'Dist Mar': 'Dist Mar', 'Qualidade': 'Qualidade', 'Produtividade': 'Produtividade', 'Conclusao': 'Conclusao', });
...
lyr_Linhasdeagua_13.set('fieldLabels', {'OBJECTID': 'no label', 'TEMA': 'no label', 'DESIGNACAO': 'no label', 'COD_RIB': 'no label', 'RIB': 'no label', 'ORDEM': 'no label', 'BACIA': 'no label', 'FREGUESIA': 'no label', 'CONCELHO': 'no label', 'INSPIREID': 'no label', 'OBS': 'no label', 'ATUALIZACA': 'no label', 'DATA_ATUAL': 'no label', 'Shape_Leng': 'no label', });
lyr_NascentesOutras_14.set('fieldLabels', {'OBJECTID': 'hidden field', 'TEMA': 'hidden field', 'DESIGNACAO': 'inline label - visible with data', 'SIST_AQUIF': 'inline label - visible with data', 'USO': 'hidden field', 'Q_M3_D': 'inline label - visible with data', 'PH': 'hidden field', 'T_COL': 'hidden field', 'CONDUCT': 'hidden field', 'CO2_LIVRE': 'hidden field', 'ALCALINIDA': 'hidden field', 'SIO2': 'hidden field', 'NA': 'hidden field', 'K': 'hidden field', 'CA': 'hidden field', 'MG': 'hidden field', 'NH4': 'hidden field', 'LI': 'hidden field', 'FE': 'hidden field', 'AL': 'hidden field', 'SO4': 'hidden field', 'CL': 'hidden field', 'F': 'hidden field', 'NO3': 'hidden field', 'LI_1': 'hidden field', 'SC': 'hidden field', 'TI': 'hidden field', 'V': 'hidden field', 'MN': 'hidden field', 'FE_1': 'hidden field', 'CO': 'hidden field', 'NI': 'hidden field', 'CU': 'hidden field', 'ZN': 'hidden field', 'AS_': 'hidden field', 'SE': 'hidden field', 'BR': 'hidden field', 'RB': 'hidden field', 'SR': 'hidden field', 'Y': 'hidden field', 'NB': 'hidden field', 'MO': 'hidden field', 'CD': 'hidden field', 'SN': 'hidden field', 'I': 'hidden field', 'CS': 'hidden field', 'BA': 'hidden field', 'LA': 'hidden field', 'CE': 'hidden field', 'ND': 'hidden field', 'TA': 'hidden field', 'W': 'hidden field', 'PB': 'hidden field', 'TH': 'hidden field', 'U': 'hidden field', 'TRATAMENTO': 'hidden field', 'ENTIDADE': 'hidden field', 'DATA': 'hidden field', 'ENVOLVENTE': 'hidden field', 'Q_MIN': 'inline label - visible with data', 'Q_MAX': 'inline label - visible with data', 'Q_MED': 'hidden field', 'POINT_X': 'inline label - visible with data', 'POINT_Y': 'inline label - visible with data', 'FREGUESIA': 'inline label - visible with data', 'CONCELHO': 'hidden field', 'RuleID_MON': 'hidden field', 'RuleID_INS': 'hidden field', });
lyr_NascentesPrincipais_15.set('fieldLabels', {'OBJECTID': 'hidden field', 'TEMA': 'hidden field', 'DESIGNACAO': 'inline label - visible with data', 'REFERENCIA': 'inline label - visible with data', 'ALTITUDE': 'inline label - always visible', 'CAUDAL': 'hidden field', 'GESTOR': 'hidden field', 'POINT_X': 'inline label - visible with data', 'POINT_Y': 'inline label - visible with data', 'FREGUESIA': 'inline label - visible with data', 'CONCELHO': 'hidden field', 'RuleID_MON': 'hidden field', 'RuleID_INS': 'hidden field', 'OBS': 'hidden field', });
lyr_Furos_16.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'id_unico': 'inline label - visible with data', 'designacao': 'inline label - visible with data', 'situacao': 'hidden field', 'X WGS84': 'inline label - visible with data', 'Y WGS84': 'inline label - visible with data', 'Z ': 'inline label - visible with data', 'Prof Agua': 'inline label - visible with data', 'Cote_Piezo': 'hidden field', 'freguesia': 'inline label - visible with data', 'freguesia deservida': 'hidden field', 'Comentario': 'header label - visible with data', 'popup': 'no label', 'popup1': 'no label', 'popup2': 'no label', 'Transmisividade': 'inline label - visible with data', 'Qexp ': 'inline label - visible with data', 'Na': 'inline label - visible with data', 'Cl': 'inline label - visible with data', 'Salinidade': 'inline label - visible with data', 'Temperatura': 'inline label - visible with data', 'Dist Mar': 'inline label - visible with data', 'Qualidade': 'hidden field', 'Produtividade': 'hidden field', 'Conclusao': 'hidden field', });
lyr_Furos_16.on('precompose', function(evt) {
