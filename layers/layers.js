...
//ol.proj.get("ESRI:102332").setExtent([334130.969579, 4259730.211282, 370911.122681, 4280515.633939]);
var wms_layers = [];
...
var format_Baciashidrograficas_2 = new ol.format.GeoJSON();
var features_Baciashidrograficas_2 = format_Baciashidrograficas_2.readFeatures(json_Baciashidrograficas_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Baciashidrograficas_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Baciashidrograficas_2.addFeatures(features_Baciashidrograficas_2);
var lyr_Baciashidrograficas_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Baciashidrograficas_2, 
                style: style_Baciashidrograficas_2,
                popuplayertitle: 'Bacias hidrograficas',
                interactive: true,
                title: '<img src="styles/legend/Baciashidrograficas_2.png" /> Bacias hidrograficas'
            });
var format_Falhasgeologicas_3 = new ol.format.GeoJSON();
var features_Falhasgeologicas_3 = format_Falhasgeologicas_3.readFeatures(json_Falhasgeologicas_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Falhasgeologicas_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Falhasgeologicas_3.addFeatures(features_Falhasgeologicas_3);
var lyr_Falhasgeologicas_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Falhasgeologicas_3, 
                style: style_Falhasgeologicas_3,
                popuplayertitle: 'Falhas geologicas',
                interactive: false,
                title: '<img src="styles/legend/Falhasgeologicas_3.png" /> Falhas geologicas'
            });
var format_SistemasaquiferosFaial_4 = new ol.format.GeoJSON();
var features_SistemasaquiferosFaial_4 = format_SistemasaquiferosFaial_4.readFeatures(json_SistemasaquiferosFaial_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_SistemasaquiferosFaial_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SistemasaquiferosFaial_4.addFeatures(features_SistemasaquiferosFaial_4);
var lyr_SistemasaquiferosFaial_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SistemasaquiferosFaial_4, 
                style: style_SistemasaquiferosFaial_4,
                popuplayertitle: 'Sistemas aquiferos Faial',
                interactive: true,
    title: 'Sistemas aquiferos Faial<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_0.png" /> Caldeira<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_1.png" /> Capelo<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_2.png" /> Cedros - Castelo Branco<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_3.png" /> Flamengos - Horta<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_4.png" /> Lomba - Alto da Cruz<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_5.png" /> Pedra-pomes da Caldeira<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_6.png" /> Pedro Miguel<br />\
    <img src="styles/legend/SistemasaquiferosFaial_4_7.png" /> Ribeirinha<br />' });
var format_Freguesias_Grupo_Central_5 = new ol.format.GeoJSON();
var features_Freguesias_Grupo_Central_5 = format_Freguesias_Grupo_Central_5.readFeatures(json_Freguesias_Grupo_Central_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'ESRI:102332'});
var jsonSource_Freguesias_Grupo_Central_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Freguesias_Grupo_Central_5.addFeatures(features_Freguesias_Grupo_Central_5);
var lyr_Freguesias_Grupo_Central_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Freguesias_Grupo_Central_5, 
                style: style_Freguesias_Grupo_Central_5,
                popuplayertitle: 'Freguesias_Grupo_Central',
                interactive: true,
                title: '<img src="styles/legend/Freguesias_Grupo_Central_5.png" /> Freguesias_Grupo_Central'
            });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(false);lyr_Baciashidrograficas_2.setVisible(false);lyr_Falhasgeologicas_3.setVisible(false);lyr_SistemasaquiferosFaial_4.setVisible(false);lyr_Freguesias_Grupo_Central_5.setVisible(false);lyr_Redesdeagua_6.setVisible(true);lyr_Ligaesentreestruturas_7.setVisible(false);lyr_Outrasinfraestruturas_8.setVisible(true);lyr_Reservatorios_9.setVisible(true);lyr_NascentesOutras_10.setVisible(true);lyr_NascentesPrincipais_11.setVisible(true);lyr_Furos_12.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OpenStreetMap_1,lyr_Baciashidrograficas_2,lyr_Falhasgeologicas_3,lyr_SistemasaquiferosFaial_4,lyr_Freguesias_Grupo_Central_5,lyr_Redesdeagua_6,lyr_Ligaesentreestruturas_7,lyr_Outrasinfraestruturas_8,lyr_Reservatorios_9,group_Nascentes,lyr_Furos_12];
lyr_Baciashidrograficas_2.set('fieldAliases', {'fid': 'fid', 'gml_id': 'gml_id', 'language': 'language', 'nativeness': 'nativeness', 'namestatus': 'namestatus', 'sourceofname': 'sourceofname', 'pronunciation': 'pronunciation', 'text': 'text', 'script': 'script', 'beginlifespanversion': 'beginlifespanversion', 'localid': 'localid', 'namespace': 'namespace', 'Area': 'Area', });
lyr_Falhasgeologicas_3.set('fieldAliases', {'fid': 'fid', 'gml_id': 'gml_id', 'localid': 'localid', 'namespace': 'namespace', 'geologichistory': 'geologichistory', 'faulttype_href': 'faulttype_href', });
lyr_SistemasaquiferosFaial_4.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'gml_id': 'gml_id', 'localid': 'localid', 'namespace': 'namespace', 'geologichistory': 'geologichistory', 'geologicunittype_href': 'geologicunittype_href', 'composition': 'composition', 'approximatedepth': 'approximatedepth', 'approximatethickness': 'approximatethickness', 'beginlifespanversion': 'beginlifespanversion', 'islayered': 'islayered', 'fid_2': 'fid_2', 'Massa de agua': 'Massa de agua', 'Area saliente': 'Area saliente', 'Litologia dominante': 'Litologia dominante', 'Tipo aquifero': 'Tipo aquifero', 'Características gerais': 'Características gerais', 'Caudal': 'Caudal', 'Caudal especifico (l/s*m)': 'Caudal especifico (l/s*m)', 'Transmissividade (m²/s)': 'Transmissividade (m²/s)', 'Permeabilidade (m/s)': 'Permeabilidade (m/s)', 'Recursos totais (hm3/an)': 'Recursos totais (hm3/an)', 'Facies predominantes': 'Facies predominantes', 'Condutividade (µS/cm)': 'Condutividade (µS/cm)', 'Anioes principais': 'Anioes principais', 'Catioes principais': 'Catioes principais', 'Outros dados relevantes': 'Outros dados relevantes', 'Fonte': 'Fonte', });
lyr_Freguesias_Grupo_Central_5.set('fieldAliases', {'DICOFRE': 'DICOFRE', 'FREGUESIA': 'FREGUESIA', 'CONCELHO': 'CONCELHO', 'ILHA': 'ILHA', 'FONTE_V3': 'FONTE_V3', 'AREA_V3_HA': 'AREA_V3_HA', });
...
lyr_Baciashidrograficas_2.set('fieldImages', {'fid': 'TextEdit', 'gml_id': 'TextEdit', 'language': 'TextEdit', 'nativeness': 'TextEdit', 'namestatus': 'TextEdit', 'sourceofname': 'TextEdit', 'pronunciation': 'TextEdit', 'text': 'TextEdit', 'script': 'TextEdit', 'beginlifespanversion': 'TextEdit', 'localid': 'TextEdit', 'namespace': 'TextEdit', 'Area': 'TextEdit', });
lyr_Falhasgeologicas_3.set('fieldImages', {'fid': 'TextEdit', 'gml_id': 'TextEdit', 'localid': 'TextEdit', 'namespace': 'TextEdit', 'geologichistory': 'TextEdit', 'faulttype_href': 'TextEdit', });
lyr_SistemasaquiferosFaial_4.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', 'gml_id': 'TextEdit', 'localid': 'TextEdit', 'namespace': 'TextEdit', 'geologichistory': 'TextEdit', 'geologicunittype_href': 'TextEdit', 'composition': 'TextEdit', 'approximatedepth': 'TextEdit', 'approximatethickness': 'TextEdit', 'beginlifespanversion': 'TextEdit', 'islayered': 'TextEdit', 'fid_2': 'TextEdit', 'Massa de agua': 'TextEdit', 'Area saliente': 'TextEdit', 'Litologia dominante': 'TextEdit', 'Tipo aquifero': 'TextEdit', 'Características gerais': 'TextEdit', 'Caudal': 'TextEdit', 'Caudal especifico (l/s*m)': 'TextEdit', 'Transmissividade (m²/s)': 'TextEdit', 'Permeabilidade (m/s)': 'TextEdit', 'Recursos totais (hm3/an)': 'TextEdit', 'Facies predominantes': 'TextEdit', 'Condutividade (µS/cm)': 'TextEdit', 'Anioes principais': 'TextEdit', 'Catioes principais': 'TextEdit', 'Outros dados relevantes': 'TextEdit', 'Fonte': '', });
lyr_Freguesias_Grupo_Central_5.set('fieldImages', {'DICOFRE': 'TextEdit', 'FREGUESIA': 'TextEdit', 'CONCELHO': 'TextEdit', 'ILHA': 'TextEdit', 'FONTE_V3': 'TextEdit', 'AREA_V3_HA': 'TextEdit', });
