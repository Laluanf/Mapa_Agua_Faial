...
var style_Outrasinfraestruturas_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Designaça") !== null && resolution > 0 && resolution < 4) {
        labelText = String(feature.get("Designaça"));
    }
