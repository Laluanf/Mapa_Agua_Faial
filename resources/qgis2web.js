...
map.getView().fit([333101.398801, 4263158.005448, 370539.714512, 4280763.355447], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de estruturas e redes de agua na ilha do Faial (Açores)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (176 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'SCR utilizado : PTRA08_UTM_Zone_26N (Grupo Central e Oriental dos Açores)<br />Autor : Laluan FERNANDES<br />Secçao : Aguas & Serviços Urbanos<br />Organismo : Câmara Municipal da Horta (CMH)';
            }
